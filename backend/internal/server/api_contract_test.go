		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"nvidia_adaptive_throttle_l1_jitter_ms": 0,
					"nvidia_adaptive_throttle_max_inflight": 0,
					...
					"nvidia_shared_connection_pool_inference_prewarm_enabled": false,
					"nvidia_shared_connection_pool_inference_prewarm_interval_sec": 3600,
					"nvidia_shared_connection_pool_inference_prewarm_model": "",
