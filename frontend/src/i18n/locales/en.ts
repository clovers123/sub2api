export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataExportIncludeGroups: 'Include groups linked to the exported accounts',
      dataImport: 'Import',
      ...
      viewColumns: 'Columns',
      selectedCount: '{count} selected',
      dataExportConfirmMessage: 'The exported data may contain sensitive account, proxy, and group information. Store it securely.',
      dataExportConfirm: 'Confirm Export',
      dataExported: 'Data exported successfully',
      dataExportFailed: 'Failed to export data',
      dataImportTitle: 'Import Data',
      dataImportHint: 'Upload the exported JSON file to import accounts, proxies, and groups.',
      dataImportWarning: 'Import will create or reuse proxies and groups, and can overwrite matching existing accounts. Only import trusted files.',
      dataImportOverwriteExisting: 'Overwrite matching existing accounts',
      ...
      dataImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Groups created {group_created}, reused {group_reused}, failed {group_failed}; Accounts created {account_created}, updated {account_updated}, failed {account_failed}',
      ...
      dataImportCompletedWithErrors: 'Import completed with errors: account failed {account_failed}, proxy failed {proxy_failed}, group failed {group_failed}',
