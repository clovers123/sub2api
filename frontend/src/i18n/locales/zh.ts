export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataExportIncludeGroups: '导出分组（导出账号关联的分组）',
      dataImport: '导入',
      moreActions: '更多操作',
      dataActions: '数据操作',
      toolActions: '工具',
      ...
      dataExportConfirmMessage: '导出的数据可能包含账号、代理与分组的敏感信息，请妥善保存。',
      dataExportConfirm: '确认导出',
      dataExported: '数据导出成功',
      dataExportFailed: '数据导出失败',
      dataImportTitle: '导入数据',
      dataImportHint: '上传导出的 JSON 文件以批量导入账号、代理与分组。',
      dataImportWarning: '导入将创建或复用代理与分组，并可覆盖已存在的同个账号；请确认文件来源可信。',
      dataImportOverwriteExisting: '覆盖已存在的同个账号',
      dataImportFile: '数据文件',
      ...
      dataImportResultSummary: '代理创建 {proxy_created}，复用 {proxy_reused}，失败 {proxy_failed}；分组创建 {group_created}，复用 {group_reused}，失败 {group_failed}；账号创建 {account_created}，更新 {account_updated}，失败 {account_failed}',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：账号创建 {account_created}，更新 {account_updated}，失败 {account_failed}',
      dataImportCompletedWithErrors: '导入完成但有错误：账号失败 {account_failed}，代理失败 {proxy_failed}，分组失败 {group_failed}',
